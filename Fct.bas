...
Function NewFd_zSpec(A As FdSpec) As dao.Field2
With A
    Set NewFd_zSpec = NewFd(.F, .Ty, .Sz, , .Dft, .Req, .VRul, .VTxt)
End With
End Function
...
Next
Debug.Print FmtQQ("AyFstPredXP: No element in Ay of NEle[?] having Pred[?] being Yes", Sz(A), XP)
End Function
